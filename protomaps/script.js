...
function getCustomSources() {
    return {
        'blm-all': {
            type: 'vector',
            url: 'pmtiles://https://pub-fd51620b0a9c4d6c914ebb61f9549df8.r2.dev/selloff-pmtiles/blm_all_hires.pmtiles',
            attribution: 'BLM Data'
        },
        'fs-all': {
            type: 'vector',
            url: 'pmtiles://https://pub-fd51620b0a9c4d6c914ebb61f9549df8.r2.dev/selloff-pmtiles/fs_all_hires.pmtiles',
            attribution: 'USFS Data'
        },
        'blm-sellable': {
            type: 'vector',
            url: 'pmtiles://https://pub-fd51620b0a9c4d6c914ebb61f9549df8.r2.dev/selloff-pmtiles/blm_sellable_hires.pmtiles',
            attribution: 'BLM Sellable Data'
        },
        'fs-sellable': {
            type: 'vector',
            url: 'pmtiles://https://pub-fd51620b0a9c4d6c914ebb61f9549df8.r2.dev/selloff-pmtiles/fs_sellable_hires.pmtiles',
